#!/usr/bin/env bash
#
wget https://downloads.plex.tv/plex-media-server-new/1.18.9.2571-e106a8a91/debian/plexmediaserver_1.18.9.2571-e106a8a91_amd64.deb
...
./cloudflared-linux-amd64 tunnel --url http://localhost:32400 &
...
# wget "https://github.com/cloudflare/cloudflared/releases/latest/download/cloudflared-linux-amd64"
# chmod +x cloudflared-linux-amd64
# cloud-torrent --port 3000 &
# wget "https://github.com/yudai/gotty/releases/download/v1.0.1/gotty_linux_amd64.tar.gz"
# tar -xvf gotty_linux_amd64.tar.gz
# ./gotty -c admin:907df714f7ff -w --address 0.0.0.0 --port 3001 /bin/bash &
# ./cloudflared-linux-amd64 tunnel --url http://localhost:3000 & 
# ./cloudflared-linux-amd64 tunnel --url http://localhost:3001
